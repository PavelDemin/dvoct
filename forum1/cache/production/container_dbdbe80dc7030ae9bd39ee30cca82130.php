...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000715bd6d90000000007794ee9(
...
class phpbbtemplatetwiglexer_00000000715bd6d90000000007794ee9 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5919ee68d46a9107379257 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5919ee68d46b6978504247 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5919ee68d4678844451544 = array(
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, 'set_environment', array('env' => $env), $this->initializer5919ee68d46b6978504247);

        return $this->valueHolder5919ee68d46a9107379257->set_environment($env);
    }
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5919ee68d46b6978504247);

        return $this->valueHolder5919ee68d46a9107379257->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5919ee68d46b6978504247);

        return $this->valueHolder5919ee68d46a9107379257->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5919ee68d46b6978504247 = $initializer;
    }
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, '__get', array('name' => $name), $this->initializer5919ee68d46b6978504247);

        if (isset(self::$publicProperties5919ee68d4678844451544[$name])) {
            return $this->valueHolder5919ee68d46a9107379257->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5919ee68d46a9107379257;
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5919ee68d46b6978504247);
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, '__isset', array('name' => $name), $this->initializer5919ee68d46b6978504247);
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, '__unset', array('name' => $name), $this->initializer5919ee68d46b6978504247);
    ...
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, '__clone', array(), $this->initializer5919ee68d46b6978504247);

        $this->valueHolder5919ee68d46a9107379257 = clone $this->valueHolder5919ee68d46a9107379257;
    }

    public function __sleep()
    {
        $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, '__sleep', array(), $this->initializer5919ee68d46b6978504247);

        return array('valueHolder5919ee68d46a9107379257');
    }
    ...
    {
        return $this->initializer5919ee68d46b6978504247;
    }
    ...
    {
        return $this->initializer5919ee68d46b6978504247 && $this->initializer5919ee68d46b6978504247->__invoke($this->valueHolder5919ee68d46a9107379257, $this, 'initializeProxy', array(), $this->initializer5919ee68d46b6978504247);
    }
    ...
    {
        return null !== $this->valueHolder5919ee68d46a9107379257;
    }
    ...
    {
        return $this->valueHolder5919ee68d46a9107379257;
    }
