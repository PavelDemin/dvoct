...
/* overall_header.html */
class __TwigTemplate_b7f0724e882973ad6d97316bfdc67be9ffa5dea4f5e7b79db80cf585b0b32388 extends Twig_Template
{
...
";
        ...
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
        $this->env->setNamespaceLookUpOrder(array('sheer_postbookmark', '__main__'));
        $this->env->loadTemplate('@sheer_postbookmark/event/overall_header_head_append.html')->display($context);
        $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        $previous_look_up_order = $this->env->getNamespaceLookUpOrder();
