...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002462e9cc0000000038f92655(
...
class phpbbtemplatetwiglexer_000000002462e9cc0000000038f92655 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5919aa7d7fd84854781026 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5919aa7d7fd90921331955 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5919aa7d7fd5f116475201 = array(
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, 'set_environment', array('env' => $env), $this->initializer5919aa7d7fd90921331955);

        return $this->valueHolder5919aa7d7fd84854781026->set_environment($env);
    }
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5919aa7d7fd90921331955);

        return $this->valueHolder5919aa7d7fd84854781026->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5919aa7d7fd90921331955);

        return $this->valueHolder5919aa7d7fd84854781026->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5919aa7d7fd90921331955 = $initializer;
    }
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, '__get', array('name' => $name), $this->initializer5919aa7d7fd90921331955);

        if (isset(self::$publicProperties5919aa7d7fd5f116475201[$name])) {
            return $this->valueHolder5919aa7d7fd84854781026->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5919aa7d7fd84854781026;
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5919aa7d7fd90921331955);
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, '__isset', array('name' => $name), $this->initializer5919aa7d7fd90921331955);
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, '__unset', array('name' => $name), $this->initializer5919aa7d7fd90921331955);
    ...
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, '__clone', array(), $this->initializer5919aa7d7fd90921331955);

        $this->valueHolder5919aa7d7fd84854781026 = clone $this->valueHolder5919aa7d7fd84854781026;
    }

    public function __sleep()
    {
        $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, '__sleep', array(), $this->initializer5919aa7d7fd90921331955);

        return array('valueHolder5919aa7d7fd84854781026');
    }
    ...
    {
        return $this->initializer5919aa7d7fd90921331955;
    }
    ...
    {
        return $this->initializer5919aa7d7fd90921331955 && $this->initializer5919aa7d7fd90921331955->__invoke($this->valueHolder5919aa7d7fd84854781026, $this, 'initializeProxy', array(), $this->initializer5919aa7d7fd90921331955);
    }
    ...
    {
        return null !== $this->valueHolder5919aa7d7fd84854781026;
    }
    ...
    {
        return $this->valueHolder5919aa7d7fd84854781026;
    }
