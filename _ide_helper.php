 ...
 * Generated for Laravel 5.1.45 (LTS) on 2017-01-26.
 *
...
namespace {
    ...
    class VK extends \Eseath\VK\Facades\VK{
         ...
         * @static 
         */
        public static function getAuthURL($params = array()){
            return \Eseath\VK\VK::getAuthURL($params);
        }
         ...
         * @return \Eseath\VK\stdClass 
         * @throws Exception
         * @static 
         */
        public static function getAccessToken($code, $redirect_uri = 'https://api.vk.com/blank.html'){
            return \Eseath\VK\VK::getAccessToken($code, $redirect_uri);
        }
        ...
        public static function setAccessToken($access_token){
            \Eseath\VK\VK::setAccessToken($access_token);
        }
         ...
         * @static 
         */
        public static function exec($method, $params = array()){
            return \Eseath\VK\VK::exec($method, $params);
        }
