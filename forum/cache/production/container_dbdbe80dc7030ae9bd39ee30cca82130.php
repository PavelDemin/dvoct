...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_00000000559d44370000000003e6131b(
...
class phpbbtemplatetwiglexer_00000000559d44370000000003e6131b extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c081ae9a1e9d568125660 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c081ae9a1eac614659357 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c081ae9a1e65422115490 = array(
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, 'set_environment', array('env' => $env), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;

        return $this->valueHolder5c081ae9a1e9d568125660->set_environment($env);
    }
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;

        return $this->valueHolder5c081ae9a1e9d568125660->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;

        return $this->valueHolder5c081ae9a1e9d568125660->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c081ae9a1eac614659357 = $initializer;
    }
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, '__get', array('name' => $name), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;

        if (isset(self::$publicProperties5c081ae9a1e65422115490[$name])) {
            return $this->valueHolder5c081ae9a1e9d568125660->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c081ae9a1e9d568125660;
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, '__isset', array('name' => $name), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, '__unset', array('name' => $name), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;
    ...
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, '__clone', array(), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;

        $this->valueHolder5c081ae9a1e9d568125660 = clone $this->valueHolder5c081ae9a1e9d568125660;
    }

    public function __sleep()
    {
        $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, '__sleep', array(), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;

        return array('valueHolder5c081ae9a1e9d568125660');
    }
    ...
    {
        return $this->initializer5c081ae9a1eac614659357;
    }
    ...
    {
        return $this->initializer5c081ae9a1eac614659357 && ($this->initializer5c081ae9a1eac614659357->__invoke($valueHolder5c081ae9a1e9d568125660, $this, 'initializeProxy', array(), $this->initializer5c081ae9a1eac614659357) || 1) && $this->valueHolder5c081ae9a1e9d568125660 = $valueHolder5c081ae9a1e9d568125660;
    }
    ...
    {
        return null !== $this->valueHolder5c081ae9a1e9d568125660;
    }
    ...
    {
        return $this->valueHolder5c081ae9a1e9d568125660;
    }
